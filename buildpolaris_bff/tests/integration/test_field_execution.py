...
class TestFieldExecution(FrappeTestCase):
    ...
    def test_daily_log_lifecycle(self):
        ...
        log_id = daily_log.create_daily_log(
        ...
        daily_log.submit_daily_log(log_id)
        log.reload()
    ...
    def test_punch_item_lifecycle(self):
        ...
        item_id = punch_list.create_punch_item(
            project=self.project_id,
        ...
        punch_list.close_punch_item(item_id, notes="Replaced tile")
        item.reload()
    ...
    def test_punch_closeout_gate(self):
        ...
        punch_list.create_punch_item(
            project=self.project_id,
            title="Gate test item",
            priority="Medium",
        )
        gate_result = punch_list.check_punch_closeout_gate(self.project_id)
    ...
    def test_safety_incident_osha_auto_flag(self):
        ...
        incident_id = safety.create_safety_incident(
            project=self.project_id,
        ...
        safety.report_safety_incident(incident_id)
        incident.reload()
    ...
    def test_jsa_approval_with_hazards(self):
        ...
        result = safety.approve_jsa(jsa_id)
